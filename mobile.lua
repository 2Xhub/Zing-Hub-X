...
ImageButton.Image = "http://www.roblox.com/asset/?id=16721259072"
...
local win = library:Window(" Zing Hub X",[[]],"",Enum.KeyCode.RightControl)
...
Main:Slider("Farm Distance",1,100,25,function(value)
 ...
 Main:Toggle('Fast Attack',true,function(famobile)
              FastAttackSpeed = famobile
            end)
...
Main:Toggle("SuperFast Attack (Rick)",_G.FastAttackNormalSpeed,function(value)
...
DevilFruit:Seperator("Esp")
	...
	DevilFruit:Toggle("ESP Flower (Sea2)",false,function(a)
		FlowerESP = a
...
if World3 then
   Race:Seperator("Moon and Mirage Island")
...
if World3 then
    ...
    Race:Seperator("Auto Mirage Island")
    Race:Toggle("Summon Mirage Island",_G.dao,function(state)
    if state then
        _G.dao = true
    else
        _G.dao = false
...
Race:Toggle("Teleport to Mirage Island",false,function(value)
...
Race:Button("Teleprot To Gear",function()
    for _,v in next, Workspace.Map.MysticIsland:GetDescendants() do
    if v.Name:find("Part") and v.ClassName == "MeshPart" then
        ...
        Race:Button("Auto Chest Mirage Island",function()
...
Race:Seperator("Teleport Race V4")

Race:Button("Teleport To Door (Your Race)",function()
 ...
 Race:Button("Teleport To CLock",function()
for _,v in next, workspace:GetDescendants() do
 ...
 Race:Seperator("Auto Trial")
  Race:Toggle("Auto Trial All Race (No Fish)",_G.winv4,function(value)
 _G.winv4 = value
 StopTween(_G.winv4)
end)
spawn(function()
...
Race:Toggle("Auto Fish Trial",_G.SeaBeasts1,function(value)
 _G.SeaBeasts1 = value
...
Race:Seperator("Buy + Turn On V4") 
 
 
  
   Race:Toggle("Auto Turn On Race V4",_G.Auto_Farm_Bone3,function(value)
...
Race:Toggle("Auto Buy Gear (Train Gear)",_G.Auto_Farm_Bone4,function(value)
...
Race:Button("Teleport to Acicent One",function()
    Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
  Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
